...
official_atlanta_hawks = Team.create(player_id: Player.first.id)

test_user = User.create(username: "test_user", password: "pass", team_id: official_atlanta_hawks.id, winloss: "0-0")